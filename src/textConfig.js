const textConfig = {
  landing: {
    title: "Happy Birthday, Madhuuuu! 🎂✨",
    subtitle: "Today is all about celebrating the most favourite person in my world. I've created a cringe birthday wish for you  on your special day...",
...
Happy Birthday,madhuuu! Here's to another year of adventures together 💕`,
  ...
  chillZone: {
    ...
    tracks: [
      { id: 1, title: "Both fav", caption: "Here's to making this year unforgettable 🌟" },
      { id: 2, title: "My fav", caption: "Because today is all about YOU, queen! 👑" },
      { id: 2, title: "Your fav...", caption: "Every beat celebrates your beautiful heart 💖" },
    ]
  },
